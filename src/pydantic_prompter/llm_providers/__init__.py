...
from pydantic_prompter.llm_providers.bedrock_openai import BedRockOpenAI
...
def get_llm(
    ...
    model_class = LLM_MODEL_MAP.get(llm, {}).get(
        model_prefix
    ) or LLM_MODEL_MAP.get(llm, {}).get("default")
    ...
    if "model_settings" in sig.parameters:
